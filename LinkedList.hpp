...
//  added project specific methods invert, invertRest and rotate
...
public:
    ...
    /***************** PROJECT-SPECIFIC PUBLIC METHODS ****************/
     ...
     //      the item previously at position 0 is at position item_count_-1,
     //      the item previously at position 1 is at position item_count_-2 ...
     //      the item previously at position ⌊item_count/2⌋ is at position ⌈item_count_/2⌉ . . .
     //     the item previously at position item_count_-1 is at position 0
    void invert();
...
private:
 ...
 //helper function to invert, used for safe programming to avoid
